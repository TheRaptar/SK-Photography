 ...
 *
 * To add a new photo: drop the image file into public/photos/<category>/,
 * then add a matching entry to the `photos` array below (and to a gallery's
 * `photoIds` if it belongs to one). No backend or database involved — the
 * site is a static build, so anything referenced here just ships with it.
 * ------------------------------------------------------------------
 */
...
export const photos: Photo[] = [
  ...
  { id: 'city-style-pink-blazer-01', title: 'Sunglasses, doorway', category: 'fashion', galleryId: 'city-style-pink-blazer', src: '/photos/portraits/city-style-pink-blazer-01.jpg', width: 1440, height: 1800, alt: 'Street style portrait outside a townhouse' },
  { id: 'city-style-pink-blazer-02', title: 'Blue door', category: 'fashion', galleryId: 'city-style-pink-blazer', src: '/photos/portraits/city-style-pink-blazer-02.jpg', width: 1440, height: 1800, alt: 'Street style portrait against a blue mews house' },
  { id: 'city-style-pink-blazer-03', title: 'Caught mid-step', category: 'fashion', galleryId: 'city-style-pink-blazer', src: '/photos/portraits/city-style-pink-blazer-03.jpg', width: 1440, height: 1800, alt: 'Candid street style portrait walking past a blue house' },
  { id: 'city-style-pink-blazer-04', title: 'Green backdrop', category: 'fashion', galleryId: 'city-style-pink-blazer', src: '/photos/portraits/city-style-pink-blazer-04.jpg', width: 1440, height: 1800, alt: 'Street style portrait against a hedge' },
  { id: 'city-style-pink-blazer-05', title: 'Relaxed', category: 'fashion', galleryId: 'city-style-pink-blazer', src: '/photos/portraits/city-style-pink-blazer-05.jpg', width: 1440, height: 1800, alt: 'Casual street style portrait against greenery' },
...
export const faqs: FaqItem[] = [
  {
    ...
    answer:
      'For weddings, 4–6 months ahead is ideal, especially for peak season (November–February). Portrait sessions can usually be scheduled within 2–3 weeks.',
  },
  {
    id: 'f2',
